...
\caption[Blup]{Évolution du \textit{Sharpe raito} avec $\eta = 0.001$, $A_0 = 0, B_0 = 0$ de $t=0$ à $t=2000$}
\end{figure}

  \begin{figure}[H]
\centering
\includegraphics[]{images/res/exemple_eta_0005}
\caption[Blup]{Évolution du \textit{Sharpe raito} avec $\eta = 0.005$, $A_0 = 0, B_0 = 0$ de $t=0$ à $t=2000$}
\end{figure}

  \begin{figure}[H]
\centering
\includegraphics[]{images/res/exemple_eta_too_big}
\caption[Blup]{Évolution du \textit{Sharpe raito} avec $\eta = 0.01$, $A_0 = 0, B_0 = 0$ de $t=0$ à $t=2000$}
\end{figure}
