...
l'avons implémentée. Ensuite, nous parlerons des problèmes rencontrés ainsi que les remédiations ou les pistes de solutions que nous avons trouvé.
...
Mathématiquement la descente va tendre vers un optimum et en chaînant les dérivations cela permet d'accélérer le phénomène.
...
\begin{itemize}
 ...
 indication sur les valeurs optimale. On suppose donc que l'optimisation annule le caractère aléatoire et donne des résultats similaires malgré des
...
peu de confiance à la direction initiée par le dit signal. Notre $y$ représente le seuil, il y a deux cas :
...
où tout les \textit{Thread} ont terminé et de prendre le meilleur résultat. De part le peu de synchronisation nécessaire, cela ne crée pas de perte de
...
\end{itemize}
 ...
 De plus, nous ne connaissons pas le domaine dans lequel chercher les solutions ce qui handicape grandement la dite recherche. Si la déviation 
