...
reinforcement learning"} \cite{fx_trading}. Ce dernier n'est pas totalement décrit car l'article
...
compréhension sont décrites dans l'état de l'art précédant cette partie. Néanmoins, les équations importantes seront répétées et exposées à nouveaux dans
un soucis de rigueur scientifique.
