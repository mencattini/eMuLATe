...
Afin de mieux discerner les éléments importants, nous avons décomposer les  données en cinq graphiques différents, rendant l'ensemble plus lisible.
 ...
 \begin{figure}[H]
\centering
\includegraphics[scale=0.85]{res/eursud_2000-2001_from_0to_10000}
...
\footnotetext{Valeur de $\rho$ avant l'optimisation par RMSProp}
 ...
 \begin{figure}[H]
\centering
\includegraphics[scale=0.85]{res/eursud_2000-2001_from_10000to_20000}
\caption[Blup]{Cours EUR/USD entre le 01.01.2000 et le 01.01.2002, avec $|w| = 20$, $2000$ éléments d'entraînement, $500$ de test, une optimisation des
...
\end{figure}
 ...
 \begin{figure}[H]
	\centering
	\includegraphics[scale=0.85]{res/eursud_2000-2001_from_20000to_30000}
	\caption[Blup]{Cours EUR/USD entre le 01.01.2000 et le 01.01.2002, avec $|w| = 20$, $2000$ éléments d'entraînement, $500$ de test, une optimisation des
...
\end{figure}
 ...
 \begin{figure}[H]
	\centering
	\includegraphics[scale=0.85]{res/eursud_2000-2001_from_30000to_40000}
	\caption[Blup]{Cours EUR/USD entre le 01.01.2000 et le 01.01.2002, avec $|w| = 20$, $2000$ éléments d'entraînement, $500$ de test, une optimisation des
...
\end{figure}
 ...
 \begin{figure}[H]
	\centering
	\includegraphics[scale=0.85]{res/eursud_2000-2001_from_40000to_50000}
	\caption[Blup]{Cours EUR/USD entre le 01.01.2000 et le 01.01.2002, avec $|w| = 20$, $2000$ éléments d'entraînement, $500$ de test, une optimisation des
...
\paragraph{}
Sachant qu'une étape de \textit{backtesting} consiste à apprendre avec 2000 éléments et de prédire les 500 éléments suivants, pour 100 itérations, le programme prend en moyenne 16s\footnote{La moyenne porte sur 100 essais différents afin d'avoir un résultat stable.}.
