...
\subsubsection{Résultats}
 ...
 Afin de faciliter la comparaison avec l'article sur lequel est basé notre projet, nous allons utiliser les mêmes données. À savoir le cours EURUSD de Janvier 2000 à Janvier 2002. La granularité des données est d'une mesure toutes les minutes.
  ...
  \todo[inline]{refaire graphique avec sharpe filter + corriger légende + aggrandir le text sur graph + ajouter références}
 \begin{sidewaysfigure}
 	\centering
...
\footnotetext{Valeur de $\rho$ avant l'optimisation par RMSProp}
 ...
 \paragraph{}
 \todo[inline]{rajouter graphique de performance de l'article}
...
Afin de mieux discerner les éléments importants, nous avons décomposer les  données en cinq graphiques différents, rendant l'ensemble plus lisible.
  \todo[inline]{refaire graphique avec sharpe filter + corriger légende + aggrandir le text sur graph + ajouter références} \begin{sidewaysfigure}
\centering
