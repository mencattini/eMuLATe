...
humaine pour trouver les meilleures valeurs possibles.
...
\end{itemize}
  ...
  \paragraph{}
  Pour ce paragraphe, nous sommes dans un état où la descente du gradient et le \textit{Layer 2} fonctionnent. Nous nous intéressons donc à la couche 
  ...
  faut modifier la déviation standard. Les nouvelles mesures sont calculés :
  $$x_{t+1} = N(\mu, \sigma)$$
