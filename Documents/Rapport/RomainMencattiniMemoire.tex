...
Pour finir cet état de l'art, nous conclurons en expliquant pourquoi avoir choisi un algorithme plutôt qu'un autre ainsi que les 
éléments à retenir du domaine de \textit{machine learning}

\paragraph{}
Après l'état de l'art, nous implémenterons l'algorithme. De cette action découlera une analyse plus poussée de sa partie mathématique,
mais également de son application au domaine de la finance. Il y sera également questions des problèmes et solutions trouvés ainsi que
des choix faits, lors de sa création.

Une fois cette partie terminée, plusieurs \textit{benchmark} seront effectués afin d'estimer quelles améliorations sont les plus
pertinentes et la performance générale de l'algorithme.

\paragraph{}
Dans la dernière partie, nous tirerons des conclusions des résultats obtenus. Nous analyserons la pertinence des algorithmes et des
optimisations et nous proposerons des pistes d'améliorations.
